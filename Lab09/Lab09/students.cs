    ...
    class CollectionOfList
    {
        ...
        public static string PickAStudent(uint numberOnArray, string newName)
        {
            ...
            if (numberOnArray > 20)
            {
                ...
                studentNames.Insert(0, new KeyValuePair<uint, string>(numberOnArray, newName));
        ...
        public static string SelectHometown(uint numberOnArray, string newHometown)
        {
            ...
            if (numberOnArray > 20)
            {
                ...
                studentHomeTowns.Insert(0, new KeyValuePair<uint, string>(numberOnArray, newHometown));
        ...
        public static string SelectFood(uint numberOnArray, string newFood)
        {
            ...
            if (numberOnArray > 20)
            {
                ...
                food.Insert(0, new KeyValuePair<uint, string>(numberOnArray, newFood));
        ...
        public static string SelectColor(uint numberOnList, string newColor)
        {
            ...
            {
                new KeyValuePair<uint, string>(1, "Red"),
                new KeyValuePair<uint, string>(2, "Green"),
                new KeyValuePair<uint, string>(3, "Orange"),
                new KeyValuePair<uint, string>(4, "Yellow"),
                new KeyValuePair<uint, string>(5, "Pink"),
                new KeyValuePair<uint, string>(6, "Blue"),
                new KeyValuePair<uint, string>(7, "Red"),
                new KeyValuePair<uint, string>(8, "Red"),
                new KeyValuePair<uint, string>(9, "Blue"),
                new KeyValuePair<uint, string>(10, "Purple"),
            ...
            if (numberOnList > 20)
            {
                ...
                color.Insert(0, new KeyValuePair<uint, string>(numberOnList, newColor));
